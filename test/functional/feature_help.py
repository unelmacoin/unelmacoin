...
"""Verify that starting unelmacoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start unelmacoin with -h for help text")
        ...
        self.log.info("Start unelmacoin with -version for version information")
