...
const char * const BITCOIN_CONF_FILENAME = "unelmacoin.conf";
const char * const BITCOIN_PID_FILENAME = "unelmacoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/UnelmaCoin";
#else
    // Unix
