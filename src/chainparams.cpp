...
{
    const char* pszTimestamp = "Yet another alternative coin, UnelmaCoin";
    const CScript genesisOutputScript = CScript() << ParseHex("048E9054ABB91F07A23AD676B4D7BE3CC9D051B6358493D1D24D0F555E478F9403EDFCD1BA5BCE347E8734C93D55CC108FF2FFE57D40221987375A26352106B03F") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("ed4504e60092e6c5873b4652058473e539b0e02b7165a17b9af0f670f1f96732");
        ...
        consensus.defaultAssumeValid = uint256S("0xed4504e60092e6c5873b4652058473e539b0e02b7165a17b9af0f670f1f96732"); //1441280
        ...
        genesis = CreateGenesisBlock(1618653728, 611703, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xed4504e60092e6c5873b4652058473e539b0e02b7165a17b9af0f670f1f96732"));
        assert(genesis.hashMerkleRoot == uint256S("0xb7e6869608db9e5cae7d425f097818b2bbf1ed988305bf3222b0dbc9ca0710c9"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.unelmacoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.unelmacointools.com");
        //vSeeds.emplace_back("dnsseed.unelmacoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xd5849763ad7f57199cf486c900684cac8cc66db08416899a8cf6cbab33c5783b"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 366114, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd5849763ad7f57199cf486c900684cac8cc66db08416899a8cf6cbab33c5783b"));
        assert(genesis.hashMerkleRoot == uint256S("0xb7e6869608db9e5cae7d425f097818b2bbf1ed988305bf3222b0dbc9ca0710c9"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.unelmacointools.com");
        //vSeeds.emplace_back("seed-b.unelmacoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1e132a11280ad72855fe843538266df5f05f3905c290a938f155ae3b47e306bc"));
        assert(genesis.hashMerkleRoot == uint256S("0xb7e6869608db9e5cae7d425f097818b2bbf1ed988305bf3222b0dbc9ca0710c9"));
